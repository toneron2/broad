...
**Owner**: TODOMODO.IO AGENCY LLC
**Author**: Anthony R. Slosar

This directory holds the design specification for the Logic Engine and the draft that was
prepared from it.
...
- `src/logic-engine/` — the shell proof of concept of the specification's Figure 26.
- [URGE](https://github.com/toneron2/URGE) — the Rust implementation, published on crates.io.

## Contact

Anthony R. Slosar · TODOMODO.IO AGENCY LLC · https://t.me/toneron2
